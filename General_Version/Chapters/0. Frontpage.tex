...
\draw[line width=1mm, Red-joyful]($(logo.east)!0.5!(title.west)$) +(0,\subtitley) -- +(0,\titley);
...
\tikz[remember picture,overlay]\node[anchor=south,inner sep=0pt] at (current page.south) {\includegraphics[width=\paperwidth]{Figures/0. General/banner.png}};
